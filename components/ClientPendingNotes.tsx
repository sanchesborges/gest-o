...
export const ClientPendingNotes: React.FC = () => {
    ...
    <div className="space-y-6 p-6 pt-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Notas Pendentes por Cliente</h2>
        </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="border-b-4 border-indigo-600 pb-4 mb-6 text-center">
          ...
          <p className="text-center text-gray-600 mt-2">Notas Pendentes • {cliente?.nome || 'Cliente'}</p>
        ...
        {notasPendentes.length === 0 ? (
          <p className="text-center text-gray-500 py-10">Nenhuma nota pendente encontrada no período.</p>
        ) : (
